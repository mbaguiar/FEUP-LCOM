 ...
 * @param transparency 1 checks transparency colour, 0 doesn't check transparency colour
 */
void drawBitmap(Bitmap* bitmap, int x, int y, Alignment alignment, int transparency);
...
/**
 * @brief switchs frame buffer with double buffer
 */
